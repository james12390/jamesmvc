...
namespace jamesmvc.Migrations
{
    ...
    [Migration("20250513224254_Tracking")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("jamesmvc.Models.LogisticsViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("jamesmvc.Models.TrackingRecord", b =>
                {
                    ...
                    b.Property<int>("LogisticsViewModel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("jamesmvc.Models.TrackingRecord", b =>
                {
                    b.HasOne("jamesmvc.Models.LogisticsViewModel", "Order")
                        .WithMany()
                        .HasForeignKey("LogisticsViewModel")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
